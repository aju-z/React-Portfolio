      ...
      <div className="md:flex md:justify-between md:gap-16 md:mt-32">
        ...
        >
          ...
          <p className="mt-10 mb-7">
            I have honed my skills in HTML, CSS, and JavaScript, allowing me to
            create visually appealing and interactive websites. I love bringing
            designs to life by carefully crafting user-friendly interfaces that
      ...
      <div className="md:flex md:justify-between mt-16 gap-32">
        ...
        >
          ...
          <p className="mt-5">
            ...
            websites using HTML, CSS, and JavaScript. Deliver high-quality code
        ...
        >
          ...
          <p className="mt-5">
            By leveraging new tools, frameworks, and techniques, I aim to create
            unique and cutting-edge websites that provide exceptional user
            experiences.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="mt-5">
            I strive to develop unique and visually captivating websites,
            Ultimately delivering websites that are not only visually stunning
